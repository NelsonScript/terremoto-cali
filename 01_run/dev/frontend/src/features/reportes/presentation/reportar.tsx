...
import { enviarReporteRequest } from '@features/reportes/application/redux/reportes.actions';
import { selectReportes } from '@features/reportes/application/redux/reportes.selectors';
...
export const Reportar: FC = () => {
  const dispatch = useDispatch<AppDispatch>();
  const { estado, error } = useSelector(selectReportes);
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    dispatch(
      enviarReporteRequest({
        tipo: TIPOS.find((t) => t.id === tipo)?.texto ?? tipo,
        departamento,
  ...
  return (
    <>
      <AlertBanner nivel="critico" titulo="Si hay una vida en riesgo, llama primero">
