# Ayuda Cali — Sitio de respuesta al terremoto del 10 de agosto de 2026
...
la emergencia por el sismo de magnitud 7,4 en el occidente colombiano.
...
necesidades por zona, líneas de emergencia, apoyo privado, fuentes) vive en
...
| Archivo | Contenido |
|---|---|
| `src/data/meta.json` | Datos generales del evento y fecha de última actualización |
| `src/data/cifras.json` | Cifras clave (fallecidos, heridos, desaparecidos, rescatados) por zona |
| `src/data/zonas.json` | Situación y necesidades específicas de cada zona (Cali, Chocó, Pereira, Manizales) |
| `src/data/hospitales.json` | Estado de la red hospitalaria |
| `src/data/albergues.json` | Albergues y puntos de acopio |
| `src/data/lineas.json` | Líneas de emergencia |
| `src/data/apoyo-privado.json` | Empresas/organizaciones que están apoyando |
